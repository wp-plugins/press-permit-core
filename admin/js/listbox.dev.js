...
$.fn.DynamicListbox = function(args) {  
	...
	*/
	...
	var ajax_request= function(stext) {
		...
		var data = { 'pp_agent_search': stext, 'pp_role_search' : roletext, 'pp_agent_type' : args.agent_type, 'pp_agent_id' : args.agent_id, 'pp_topic' : args.topic, 'pp_usermeta_key' : umkey, 'pp_usermeta_val' : umval, 'pp_omit_admins' : ppListbox.omit_admins, 'pp_metagroups' : ppListbox.metagroups, 'pp_operation' : args.op, 'pp_context' : args.pp_context };
